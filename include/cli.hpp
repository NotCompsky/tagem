...
int get_which(const char* const prompt_fmt,  const char* const printf_arg,  const flag::ArgSeparator f,  Opts... opts){
/*template<typename... Args,  typename... Opts>
...
template<typename... Args>
char* get_trim(const char* const trim_from,  const char* const prompt_fmt,  Args... printf_args){
	while(true){
